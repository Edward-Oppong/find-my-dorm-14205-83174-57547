    ...
    <footer className="bg-card border-t">
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          {/* For Hostels */}
          <div>
            <h3 className="font-semibold mb-4">For Hostel Owners</h3>
            <ul className="space-y-2 text-sm">
              <li>
                <Link to="/list-hostel" className="text-muted-foreground hover:text-primary transition-colors">
                  List Your Hostel
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              <li className="flex items-center gap-2 text-muted-foreground">
                ...
                <a href="mailto:support@hostelhub.com" className="hover:text-primary transition-colors">
